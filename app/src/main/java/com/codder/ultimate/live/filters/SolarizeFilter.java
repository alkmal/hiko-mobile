...
public class SolarizeFilter extends BaseFilter implements OneParameterFilter {
    ...
    private static final String TAG = "SolarizeFilter";
    ...
    public void onCreate(int programHandle) {
        ...
        try {
            ...
            if (mThresholdLocation < 0) {
                Log.e(TAG, "Uniform location for 'threshold' is invalid.");
            }
        } catch (Exception e) {
    ...
    protected void onPreDraw(long timestampUs, @NonNull float[] transformMatrix) {
        ...
        try {
            if (mThresholdLocation >= 0) {
                ...
                Egloo.checkGlError("glUniform1f(threshold)");
            } else {
                Log.w(TAG, "mThresholdLocation is invalid, uniform not set.");
            }
        } catch (Exception e) {
            Log.e(TAG, "Error setting uniform in onPreDraw: " + e.getMessage(), e);
        }
    }
}
